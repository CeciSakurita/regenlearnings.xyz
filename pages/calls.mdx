...
### Unlock Protocol: 
The use of NFT ticketing via Unlock Protocol was highlighted, with Cecilia providing an example by creating tickets for this call, showcasing the ease of distributing NFTs for event access.  For future calls it will be implemented so everyone will be able to RSVP their ticket for the call and enjoy with an NFT.
